...
APP_SSO = env.get("APP_SSO", "False").lower() == "true"
APP_KEY = str(env.get("APP_KEY", "secret"))  # os.urandom(24)  # TODO: add to cli --generate
APP_REGISTRATION = env.get("APP_REGISTRATION", "False").lower() == "true"
...
# API Spec is built by Future from registered routes when OPENAPI.enabled is True.
# See config["OPENAPI"] and future.openapi.openapi_routes().
API_SPEC = {
