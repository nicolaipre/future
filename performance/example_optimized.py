#!/usr/bin/env python3
"""
Optimized Future Framework Example
Demonstrates performance improvements with C extensions.
"""
...
routes: Sequence[Route | RouteGroup] = [  # type: ignore
    ...
    Get(path="/json", endpoint=DebugController.json_response, name="json"),  # type: ignore[reportAttributeAccessIssue]
...
config = {
    "APP_NAME": "Future Optimized",
    "APP_DOMAIN": APP_DOMAIN,
    "APP_DEBUG": False,  # Disable debug for performance
    "APP_LOG_LEVEL": "WARNING",  # Reduce logging
